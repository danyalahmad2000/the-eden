...
export default function Home() {
  ...
  const handleWhatsApp = () => {
    window.open('https://wa.me/971XXXXXXXXX?text=Hi, I am interested in The Eden at Sobha Central Dubai', '_blank');
  };

  const handleDownloadBrochure = () => {
    // In a real implementation, this would trigger a download
    alert('Brochure download will start shortly. Please provide your contact details for instant access.');
    scrollToSection('contact');
  };

  const handleVideoTour = () => {
    alert('Virtual tour will open shortly. Experience The Eden from the comfort of your home.');
  };
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-[#1A365D] tracking-tight">The Eden</h1>
                <p className="text-sm text-gray-600 font-medium">Sobha Central Dubai</p>
              </div>
            </div>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 pb-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            {/* Left Content */}
            <div className={`text-white space-y-8 transform transition-all duration-1000 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
              {/* Premium Badge */}
              <div className="inline-flex items-center space-x-2 bg-[#D4AF37]/20 backdrop-blur-sm border border-[#D4AF37]/30 rounded-full px-6 py-3">
                ...
                <span className="text-[#D4AF37] font-semibold">Exclusive Launch Offer</span>
                <Badge className="bg-red-500 text-white text-xs animate-pulse">Limited Time</Badge>
              </div>

              {/* Main Headline */}
              <div className="space-y-4">
                <h1 className="text-5xl lg:text-7xl font-bold leading-tight">
                  The <span className="text-[#D4AF37] relative">
                    Eden
              ...
              <p className="text-xl lg:text-2xl text-gray-300 max-w-2xl leading-relaxed">
                Where luxury meets lifestyle. Experience unparalleled elegance in Dubai's most prestigious address.
              </p>

              {/* Key Features */}
              <div className="flex flex-wrap gap-4">
                {[
                  { icon: Home, text: "1, 2 & 3 BHK" },
                  ...
                  <div 
                    key={index}
                    className={`flex items-center space-x-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 transform transition-all duration-500 delay-${index * 100}`}
            ...
            <div className={`transform transition-all duration-1000 delay-300 ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'}`}>
              <Card className="bg-white/95 backdrop-blur-sm shadow-2xl border-0 overflow-hidden">
                <div className="bg-gradient-to-r from-[#D4AF37] to-[#B8941F] p-6 text-center">
                  ...
                  <p className="text-white/90">Limited units available • Special launch pricing</p>
                </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              >
                ...
                <div className="text-4xl font-bold text-[#1A365D] mb-2">{stat.number}</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              The Eden at Sobha Central represents the pinnacle of contemporary luxury, 
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              {activeTab === 'overview' && (
                <div className="space-y-6 animate-fadeIn">
                  <h3 className="text-3xl font-bold text-[#1A365D]">Architectural Excellence</h3>
                  <p className="text-lg text-gray-600 leading-relaxed">
                    Each residence at The Eden is a masterpiece of design, featuring premium finishes, 
                    spacious layouts, and floor-to-ceiling windows that frame breathtaking views of Dubai's skyline.
                  </p>
                  <div className="grid grid-cols-2 gap-6">
                    {[
                      { icon: Building2, title: "Premium Apartments", desc: "1, 2 & 3 BHK units" },
                      { icon: MapPin, title: "Prime Location", desc: "Sobha Central Dubai" },
                      { icon: Users, title: "Family Friendly", desc: "Kid-safe environment" },
                      { icon: Shield, title: "24/7 Security", desc: "Premium safety" }
                    ].map((item, index) => (
              ...
              {activeTab === 'features' && (
                <div className="space-y-6 animate-fadeIn">
                  <h3 className="text-3xl font-bold text-[#1A365D]">Premium Features</h3>
                  <p className="text-lg text-gray-600 leading-relaxed">
                    Every aspect of The Eden has been carefully considered to provide residents with 
              ...
              {activeTab === 'investment' && (
                <div className="space-y-6 animate-fadeIn">
                  <h3 className="text-3xl font-bold text-[#1A365D]">Investment Opportunity</h3>
                  <p className="text-lg text-gray-600 leading-relaxed">
                    The Eden offers exceptional investment potential with attractive rental yields 
                    and strong capital appreciation prospects.
                  </p>
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      ...
                      <div key={index} className="bg-gradient-to-r from-[#D4AF37]/10 to-[#D4AF37]/5 p-4 rounded-lg">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-8 -left-8 bg-white p-8 rounded-2xl shadow-2xl border border-gray-100">
                <h4 className="font-bold text-[#1A365D] mb-2 text-lg">Starting From</h4>
                <p className="text-3xl font-bold text-[#D4AF37] mb-1">AED 1.2M</p>
      ...
      <section id="amenities" className="py-24 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold text-[#1A365D] mb-6">Resort-Style Amenities</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Experience over 40 world-class amenities designed to elevate your lifestyle
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: Waves, title: "Infinity Pool", desc: "Olympic-size pool with city views", category: "Recreation" },
              { icon: Dumbbell, title: "Premium Gym", desc: "State-of-art fitness center", category: "Fitness" },
              { icon: Trees, title: "Landscape Gardens", desc: "Manicured gardens & walking trails", category: "Nature" },
              { icon: Users, title: "Kids Play Area", desc: "Safe playground for children", category: "Family" },
              { icon: Coffee, title: "Café & Restaurant", desc: "Fine dining experiences", category: "Dining" },
              { icon: Car, title: "Valet Parking", desc: "Premium parking services", category: "Convenience" },
              { icon: Wifi, title: "High-Speed WiFi", desc: "Complimentary internet access", category: "Technology" },
              { icon: Gamepad2, title: "Gaming Lounge", desc: "Entertainment for all ages", category: "Entertainment" },
              { icon: ShoppingBag, title: "Retail Outlets", desc: "Shopping & services", category: "Retail" }
            ].map((amenity, index) => (
              <Card 
                key={index}
              ...
              >
                <CardContent className="p-8 text-center relative">
                  <div className="absolute top-4 right-4">
                    <Badge variant="outline" className="text-xs text-[#D4AF37] border-[#D4AF37]">
                      {amenity.category}
                    </Badge>
                  </div>
                  ...
                  <h3 className="text-xl font-bold text-[#1A365D] mb-3">{amenity.title}</h3>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div>
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Strategically positioned in the heart of Dubai with unmatched connectivity 
                  to the city's major landmarks and business districts.
                </p>
              </div>
              
              <div className="space-y-6">
                {[
                  { icon: Building2, title: "5 min to Downtown Dubai", desc: "Burj Khalifa & Dubai Mall", time: "5 min" },
                  { icon: Plane, title: "20 min to Dubai Airport", desc: "International connectivity", time: "20 min" },
                  { icon: Train, title: "Metro Station Nearby", desc: "Public transport access", time: "2 min" },
                  { icon: ShoppingBag, title: "Premium Shopping", desc: "Major retail destinations", time: "10 min" },
                  { icon: Building2, title: "Business Bay", desc: "Financial district", time: "15 min" },
                  { icon: MapIcon, title: "Dubai Marina", desc: "Waterfront lifestyle", time: "25 min" }
                ].map((location, index) => (
                  <div 
                    key={index}
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h4 className="font-bold text-[#1A365D] text-lg">{location.title}</h4>
                      <p className="text-gray-600">{location.desc}</p>
                    </div>
                    <div className="text-right">
                      <div className="text-2xl font-bold text-[#D4AF37]">{location.time}</div>
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-6 left-6 text-white">
                ...
                <p className="text-white/90">Connected to everything that matters</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="floorplans" className="py-24 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold text-[#1A365D] mb-6">Choose Your Perfect Home</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Thoughtfully designed floor plans that maximize space, natural light, and stunning views
            </p>
          </div>
            ...
            {[
              {
                ...
                badge: "Available",
                features: ["Open kitchen", "Balcony", "Built-in wardrobes", "Premium finishes"]
              },
              {
                type: "2 Bedroom",
                area: "950 - 1100 sq ft",
                ...
                badge: "Most Popular",
                features: ["Master bedroom", "Guest bathroom", "Dining area", "Storage room"]
              },
              {
                type: "3 Bedroom",
                ...
                badge: "Premium",
                features: ["En-suite bathrooms", "Maid's room", "Large balcony", "Study area"]
              }
            ].map((plan, index) => (
              <Card 
                key={index}
              ...
              >
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4">
                    <Badge className={`${
                      index === 1 ? 'bg-[#D4AF37] text-black' : 'bg-white text-[#D4AF37]'
                    } font-semibold`}>
                      {plan.badge}
                    </Badge>
                  </div>
                ...
                <CardContent className="p-8">
                  <h3 className="text-2xl font-bold text-[#1A365D] mb-3">{plan.type}</h3>
                  <p className="text-gray-600 mb-4">Perfect for modern living</p>
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-[#D4AF37] text-xl">{plan.price}</span>
                    </div>
                  </div>

                  <div className="space-y-2 mb-6">
                    <h4 className="font-semibold text-[#1A365D]">Key Features:</h4>
      ...
      <section id="gallery" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold text-[#1A365D] mb-6">Visual Experience</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Explore The Eden through our curated gallery of interiors, amenities, and lifestyle moments
            </p>
          </div>
            ...
            <div className="text-white space-y-8">
              <div>
                ...
                <p className="text-xl text-gray-300 leading-relaxed">
                  With over 45 years of excellence in real estate development, Sobha Realty has delivered 
                  world-class projects across the Middle East. Known for quality construction, timely delivery, 
              ...
              <div className="grid grid-cols-2 gap-8">
                {[
                  ...
                  { number: "100%", label: "On-Time Delivery", icon: CheckCircle }
                ].map((stat, index) => (
      ...
      <section id="contact" className="py-24 bg-gradient-to-b from-[#1A365D] to-[#0F1B2E]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white mb-16">
            <h2 className="text-5xl font-bold mb-6">Ready to Call The Eden Home?</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Connect with our luxury property experts today. Limited units available with exclusive launch pricing.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <Card className="bg-white shadow-2xl">
              <div className="bg-gradient-to-r from-[#D4AF37] to-[#B8941F] p-8 text-center">
                <h3 className="text-3xl font-bold text-white mb-3">Get Exclusive Access</h3>
                <p className="text-white/90">Priority booking • Special launch pricing • Expert consultation</p>
              </div>
            ...
            <div className="space-y-8">
              <div className="text-white space-y-6">
                ...
                <p className="text-xl text-gray-300 leading-relaxed">
                  Our luxury property consultants are available 24/7 to assist you with your investment journey.
                </p>
              </div>
                  ...
                  >
                    <CardContent className="p-6 flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-[#D4AF37] font-semibold">{contact.info}</p>
              ...
              <div className="bg-gradient-to-r from-[#D4AF37]/20 to-[#D4AF37]/10 backdrop-blur-sm rounded-2xl p-8 border border-[#D4AF37]/30">
                <h4 className="text-2xl font-bold text-white mb-4">Why Choose The Eden?</h4>
                <div className="space-y-3">
                  {[
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 mb-6 max-w-md leading-relaxed">
                Experience luxury living at its finest. The Eden at Sobha Central Dubai offers 
                premium apartments with world-class amenities in Dubai's most prestigious location.
              </p>
            ...
            <div>
              ...
              <div className="space-y-2">
                {[
                  { label: 'Project Overview', action: () => scrollToSection('overview') },
                  { label: 'Amenities', action: () => scrollToSection('amenities') },
                  { label: 'Location', action: () => scrollToSection('location') },
                  { label: 'Floor Plans', action: () => scrollToSection('floorplans') },
          ...
          <div className="border-t border-gray-700 pt-8 text-center">
            <p className="text-gray-500">
              © 2024 The Eden at Sobha Central Dubai. All rights reserved. | Developed by Sobha Realty
            </p>
            <p className="text-gray-600 text-sm mt-2">
              This website is for informational purposes only. All images are for illustration purposes. 
              Actual product may vary. Please consult with our sales team for accurate information.
            </p>
          </div>
        </div>
      </footer>
